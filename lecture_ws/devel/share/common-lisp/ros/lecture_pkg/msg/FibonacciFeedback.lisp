...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lecture_pkg-msg:<FibonacciFeedback> is deprecated: use lecture_pkg-msg:FibonacciFeedback instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lecture_pkg-msg:sequence-val is deprecated.  Use lecture_pkg-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FibonacciFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#fedback~%int32[] sequence~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FibonacciFeedback)))
  "Returns full string definition for message of type 'FibonacciFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#fedback~%int32[] sequence~%~%~%"))
