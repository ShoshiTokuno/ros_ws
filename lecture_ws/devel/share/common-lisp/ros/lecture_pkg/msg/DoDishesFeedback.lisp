...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lecture_pkg-msg:<DoDishesFeedback> is deprecated: use lecture_pkg-msg:DoDishesFeedback instead.")))

(cl:ensure-generic-function 'percent_complete-val :lambda-list '(m))
(cl:defmethod percent_complete-val ((m <DoDishesFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lecture_pkg-msg:percent_complete-val is deprecated.  Use lecture_pkg-msg:percent_complete instead.")
  (percent_complete m))
